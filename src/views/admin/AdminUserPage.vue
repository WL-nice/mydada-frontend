<template>
  ...
  >
    ...
    <a-form-item field="userAccount" label="用户简介">
      <a-input
        allow-clear
...
const formSearchParams = ref<UserQueryRequest>({});
...
const loadData = async () => {
  const res = await UserControllerService.userSearch(searchParams.value);
  if (res.code === 0) {
