...
const loadData = async () => {
  ...
  // 获取 app
  let res: any = await AppControllerService.getAppVo(props.appId as any);
  if (res.code === 0) {
  ...
  // 获取题目
  res = await QuestionControllerService.listQuestionVoByPage({
...
const doSubmit = async () => {
  ...
  if (res.code === 0 && res.data) {
    ...
    message.error("提交答案失败，" + res.message);
  }
